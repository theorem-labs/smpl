...
To install from the opam repository for Coq 8.17 and onwards use the following 
commands:

    opam repo add coq-released https://coq.inria.fr/opam/released
    opam update
    opam install coq-smpl.8.17
...
in a directory of your project.
    ...
    git clone -v coq-8.17 https://github.com/uds-psl/smpl.git
    cd smpl
    make
